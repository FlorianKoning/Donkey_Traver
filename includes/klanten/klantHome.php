...
<head>
    ...
    <title>donkey travel | klant Home</title>
</head>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="klantHome.php">Klant home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="klantDelete1.php">Delete</a>
                        </li>
                        <li class="nav-item">
